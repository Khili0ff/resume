...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _tasks_create__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tasks/create */ \"./src/js/tasks/create.js\");\n/* harmony import */ var _tasks_sort__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tasks/sort */ \"./src/js/tasks/sort.js\");\n\r\n\r\n\n\n//# sourceURL=webpack://resume/./src/js/tasks.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _create__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create */ \"./src/js/tasks/create.js\");\n\r\n\r\nconst mainContent = document.querySelector('.main');\r\nconst btnSortTasks = mainContent.querySelector('.main__filter__instruments__sort');\r\n\r\nfunction sortTasks(property, tasks, meaning = 'sort__ascending') {\r\n  let propertyTitle = btnSortTasks.querySelector('#instruments__sort').textContent;\r\n  btnSortTasks.querySelector('#instruments__sort').textContent = `${property.textContent}`;\r\n  propertyTitle = btnSortTasks.querySelector('#instruments__sort').textContent;\r\n  let sortedTasks = tasks;\r\n  // Доработать сортировку, если элемент не имеет значения(-), то сортируется в самый низ\r\n  // if (el.date === '-') вниз\r\n  // if (el.deadline === '-') вниз\r\n  // if (el.priority === '-') вниз\r\n  switch (propertyTitle) {\r\n    case 'Приоритет':\r\n      if (meaning === 'sort__ascending') sortedTasks = tasks.sort((a, b) => a.priority.dimension - b.priority.dimension);\r\n      if (meaning === 'sort__descending') sortedTasks = tasks.sort((a, b) => b.priority.dimension - a.priority.dimension);\r\n      break;\r\n    case 'Дата':\r\n      if (meaning === 'sort__ascending') sortedTasks = tasks.sort((a, b) => new Date(a.date) - new Date(b.date));\r\n      if (meaning === 'sort__descending') sortedTasks = tasks.sort((a, b) => new Date(b.date) - new Date(a.date));\r\n      break;\r\n    case 'Дедлайн':\r\n      if (meaning === 'sort__ascending') sortedTasks = tasks.sort((a, b) => new Date(a.deadline) - new Date(b.deadline));\r\n      if (meaning === 'sort__descending') sortedTasks = tasks.sort((a, b) => new Date(b.deadline) - new Date(a.deadline));\r\n      break;\r\n    default:\r\n      break;\r\n  }\r\n  (0,_create__WEBPACK_IMPORTED_MODULE_0__.redrawTasks)(sortedTasks, mainContent.querySelector('.main__tasks__open').querySelector('.main__tasks__all'));\r\n}\r\n\r\n// Фикс: когда изменяем значение сортировки, включается меню выбора\r\nbtnSortTasks.addEventListener('click', event => {\r\n  let sortList = btnSortTasks.querySelector('.main__filter__instruments__sort__active');\r\n  if (sortList === null) {\r\n    if (event.currentTarget === btnSortTasks) {\r\n      btnSortTasks.insertAdjacentHTML('beforeend', `\r\n        <div class=\"main__filter__instruments__sort__active\">\r\n          <span class=\"main__filter__instruments__sort__property\" id=\"sort__property__priority\">Приоритет</span>\r\n          <span class=\"main__filter__instruments__sort__property\" id=\"sort__property__date\">Дата</span>\r\n          <span class=\"main__filter__instruments__sort__property\" id=\"sort__property__deadline\">Дедлайн</span>\r\n        </div>\r\n      `);\r\n    }\r\n    sortList = btnSortTasks.querySelector('.main__filter__instruments__sort__active');\r\n    if ((0,_create__WEBPACK_IMPORTED_MODULE_0__.getTasks)().length !== 0) {\r\n      const tasks = (0,_create__WEBPACK_IMPORTED_MODULE_0__.getTasks)().filter(el => {\r\n        if (el.parametrs.cliped === true) return false;\r\n        return true;\r\n      });\r\n      const propertyList = Array.from(sortList.querySelectorAll('.main__filter__instruments__sort__property'));\r\n      propertyList.forEach(el => el.addEventListener('click', ev => {\r\n        sortTasks(ev.target, tasks);\r\n        const sortMeaning = btnSortTasks.querySelector('.main__filter__instruments__sort__meaning');\r\n        sortMeaning.classList.add('sort__ascending');\r\n        sortMeaning.addEventListener('click', () => {\r\n          const statusMeaning = Array.from(sortMeaning.classList)[1];\r\n          if (statusMeaning === 'sort__ascending') {\r\n            sortMeaning.classList.remove('sort__ascending');\r\n            sortMeaning.classList.add('sort__descending');\r\n          } else {\r\n            sortMeaning.classList.remove('sort__descending');\r\n            sortMeaning.classList.add('sort__ascending');\r\n          }\r\n          sortTasks(ev.target, tasks, Array.from(sortMeaning.classList)[1]);\r\n        });\r\n      }));\r\n    }\r\n  } else {\r\n    btnSortTasks.removeChild(sortList);\r\n  }\r\n});\r\n\n\n//# sourceURL=webpack://resume/./src/js/tasks/sort.js?");
